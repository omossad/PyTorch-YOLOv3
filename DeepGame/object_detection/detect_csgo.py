...
if __name__ == "__main__":
    ...
    #parser.add_argument("--image_folder", type=str, default="D:\\Encoding\\encoding_files\\csgo\\frames\\gzpt\\", help="path to dataset")
    ...
    #parser.add_argument("--out_folder", type=str, default="D:\\Encoding\\encoding_files\\csgo\\model\\objects\\", help="path to output_folder")
