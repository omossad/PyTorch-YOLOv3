...
if __name__ == "__main__":
    ...
    for epoch in range(opt.epochs):
        ...
        for batch_i, (_, imgs, targets) in enumerate(dataloader):
            ...
            x_inpt1, x_inpt2, x_inpt3 = yolo_single_tile(yolo_outputs, opt.htiles, opt.classes, opt.img_size)
            x_inpt1 = Variable(x_inpt1.to(device))
            x_inpt2 = Variable(x_inpt2.to(device))
            x_inpt3 = Variable(x_inpt3.to(device))
