...
game = 'csgo'
frames_folder = 'C:\\Users\\omossad\\Desktop\\dataset\\model_data\\' + game + '\\selected_frames\\'
# fixations folder is where the frame fixations are located#
fixations_folder = 'C:\\Users\\omossad\\Desktop\\dataset\\model_data\\' + game + '\\labels\\text_labels\\'
output_folder = 'C:\\Users\\omossad\\Desktop\\dataset\\model_data\\' + game + '\\filenames\\'
...
for i in range(num_files):
	...
	labels_file = 'C:\\Users\\omossad\\Desktop\\dataset\\model_data\\' + game + '\\labels\\text_labels\\'
