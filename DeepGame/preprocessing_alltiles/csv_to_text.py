...
game = 'csgo'
input_folder = 'C:\\Users\\omossad\\Desktop\\dataset\\model_data\\' + game + '\\labels\\csv_labels\\'
# output folder is where the frame fixations will be stored#
output_folder = 'C:\\Users\\omossad\\Desktop\\dataset\\model_data\\' + game + '\\labels\\text_labels\\'
fps = utils.get_fps()
