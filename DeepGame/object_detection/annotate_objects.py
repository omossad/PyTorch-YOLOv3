...
if __name__ == "__main__":
    ...
    for img_i, (path, detections) in enumerate(zip(imgs, img_detections)):
        ...
        img_name = opt.out_folder + img_name + '.txt'
        f = open(img_name, "w")
        #print(img_name)
        # Create plot
        ...
        if detections is not None:
            ...
            for x1, y1, x2, y2, conf, cls_conf, cls_pred in detections:
                ...
                box_w = x2 - x1
                box_h = y2 - y1
                line_to_write = str(int(cls_pred)) + " " + str(c_x.item()/1920.0) + " " + str(c_y.item()/1080.0) + " "
