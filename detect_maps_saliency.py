...
def edistance(point, center):
    return ((point[0] - center[0])**2 + (point[1]-center[1])**2)**(1/2)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--out_folder", type=str, default="/home/omossad/scratch/Gaming-Dataset/maps/fifa/ha_0/", help="path to dataset")
