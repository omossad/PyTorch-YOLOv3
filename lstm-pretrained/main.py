...
########## INSERTED CODE ########
ha_0_images = sorted(glob.glob("/home/omossad/scratch/temp/roi/images/ha_0_frame_006*"))
ha_0_labels = sorted(glob.glob("/home/omossad/scratch/temp/roi/labels/ha_0_frame_006*"))
